...
opendxp.registerNS("opendxp.bundle.newsletter.document.newsletters.settings");
/**
 * @private
 */
opendxp.bundle.newsletter.document.newsletters.settings = Class.create(opendxp.document.settings_abstract, {
