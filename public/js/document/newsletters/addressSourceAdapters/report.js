...
opendxp.registerNS("opendxp.bundle.newsletter.document.newsletters.addressSourceAdapters.report");

/**
 * @private
 */
opendxp.bundle.newsletter.document.newsletters.addressSourceAdapters.report = Class.create({
                ...
                items: [
                    {
                        ...
                        store: new Ext.data.Store({
                            ...
                            proxy: {
                                type: 'ajax',
                                url: Routing.generate('opendxp_bundle_newsletter_document_newsletter_getavailablereports', {task: 'list'}),
                                reader: {
                                    type: 'json',
                                    rootProperty: 'data'
                                }
                        ...
                        id: "opendxp_newsletter_send_report_" + this.document.id,
                        width: 600,
                        displayField: 'text',
                        valueField: 'id',
                        listeners: {
                        ...
                        store: new Ext.data.JsonStore({
                            ...
                            proxy: {
                                type: 'ajax',
                                url: Routing.generate('opendxp_bundle_newsletter_document_newsletter_getavailablereports', {task: 'fieldNames'}),
                                reader: {
                                    type: 'json',
                                    rootProperty: 'data'
                                }
                            ...
                            listeners: {
                                beforeload : function(store, options) {
                                    store.getProxy().extraParams = {
                                        reportId: Ext.getCmp("opendxp_newsletter_send_report_"
