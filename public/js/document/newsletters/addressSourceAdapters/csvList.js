...
opendxp.registerNS("opendxp.bundle.newsletter.document.newsletters.addressSourceAdapters.csvList");
/**
 * @private
 */
opendxp.bundle.newsletter.document.newsletters.addressSourceAdapters.csvList = Class.create({
