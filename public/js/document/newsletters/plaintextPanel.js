...
opendxp.registerNS("opendxp.bundle.newsletter.document.newsletters.plaintextPanel");
/**
 * @private
 */
opendxp.bundle.newsletter.document.newsletters.plaintextPanel = Class.create({
    ...
    getLayout: function () {
        ...
        if (this.layout == null) {
            this.layout = new Ext.FormPanel({
                ...
                iconCls: "opendxp_material_icon_text opendxp_material_icon",
                items: [{
                    xtype:'fieldset',
